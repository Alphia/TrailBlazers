...
public interface AccountMapper {
    ...
    @Insert(
        "INSERT INTO account (account_name, email_address, password, phone_number, country, enabled) " +
        "VALUES (#{account_name}, #{emailAddress}, #{password}, #{phoneNumber}, #{country}, #{enabled})"
    )
